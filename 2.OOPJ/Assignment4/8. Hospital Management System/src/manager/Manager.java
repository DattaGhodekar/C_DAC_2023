...
// out patient          String name, int id, int age, double doctorFees, double testCharges
				new InPatient("datta", 1, 23, 12, 10000, 5000), new OutPatient("Madan", 2, 65, 15000, 5000),
				new InPatient("Saurabh", 3, 68, 12, 12512.432, 8373.22),
				new OutPatient("Mohan", 4, 59, 18234.16, 6080.12), new InPatient("amit", 5, 23, 12, 1000, 500),
